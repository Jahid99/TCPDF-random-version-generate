...
class TCPDF_STATIC {
    ...
    {
        $nine = substr(str_shuffle(str_repeat("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", 9)), 0, 9);
		$five = substr(str_shuffle(str_repeat("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", 5)), 0, 5);
		$three = substr(str_shuffle(str_repeat("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", 3)), 0, 3);
		$ver=mt_rand(1, 10).'.'.mt_rand(1, 9).'.'.mt_rand(1, 100);
		$arg = $nine.' '.$five.'/'.$three.' '.$ver;
        self::$tcpdf_version = $arg;
    }
